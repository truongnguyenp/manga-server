...
namespace BEComicWeb.Migrations
{
    ...
    [Migration("20230419193412_delete_follows")]
    partial class delete_follows
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BEComicWeb.Model.StoryModel.Translators", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BEComicWeb.Model.StoryModel.StoryAuthor", b =>
                {
                    b.HasOne("BEComicWeb.Model.StoryModel.Authors", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("BEComicWeb.Model.StoryModel.StoryTranslator", b =>
                {
                    ...
                    b.HasOne("BEComicWeb.Model.StoryModel.Translators", "Translator")
                        .WithMany()
